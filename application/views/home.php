<article>
    ...
    <article>
        ...
        <b>Website:</b>
        <p><a href="http://www.indochino.com/">www.indochino.com</a></p>
    </article>
    <br class="clear" />
    <h4>Description</h4>
...
<article>
    ...
    <article>
        ...
        <ul>
            <li>First Place in Canada in the Canadian Computing Competition (CCC) Senior Division 2012</li>
            <li>Silver Medal in the Final Stage of the CCC 2011, 2012</li>
            <li>Top 10 in Waterloo 2013 ACM Contest</li>
        </ul>
    </article>
    <h4>Description</h4>
    <p>Since entering high school, I have competed in many different programming 
        ...
        problems that I have never seen before.</p>
</article> 
...
<article>
    ...
    <article>
        ...
        <b>Duration:</b>
        <p>June 2011 – February 2012</p>
        <b>Website:</b>
        <p><a href="http://vmun.com/">vmun.com</a></p>
    </article>
    <br class="clear" />
    <h4>Description</h4>
